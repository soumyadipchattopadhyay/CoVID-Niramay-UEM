...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mywebView.loadUrl("https://gisanddata.maps.arcgis.com/apps/opsdashboard/index.html#/bda7594740fd40299423467b48e9ecf6");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.helpline : i = new Intent(
                    this, TestSelect.class);startActivity(i);break;
            case R.id.more : i = new Intent(this, More.class);startActivity(i);break;
            case R.id.appointment : i = new Intent(this, SelectTransport.class);startActivity(i);break;
            case R.id.self : i = new Intent(this, Dm.class);startActivity(i);break;
            case R.id.news : i = new Intent(this, NewsSelect.class);startActivity(i);break;
